...
class FeatureInputGenerator:
    ...
    def _load_clean(self, name):
        ...
        abs_path_one = os.path.join(DATASET_FIRST, f'{name}.mp3')
        abs_path_two = os.path.join(DATASET_SECOND, f'{name}.wav')
        abs_path_three = os.path.join(TEST_DATASET, f'{name}.wav')
